...
namespace E_Sched
{
    public partial class MainVoltageDrop : Form
    {
        ...
        public MainVoltageDrop(PhaseType phaseType, string Size)
        {
            this.wireSize = Size;
            ptype = phaseType;
            InitializeComponent();
        ...
        private void MainVoltageDrop_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void resistanceGrid_CellClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void conduitSizeGrid_Click(object sender, EventArgs e)
        {
